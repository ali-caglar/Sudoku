...
namespace Sudoku.Components
{
    public class SudokuCell : Selectable
    {
        ...
        public void SetCellAsClue()
        {
            IsClue = true;
            interactable = false;
            _numberTMP.color = SudokuRule.ClueTextColor;
        }
        ...
        private void SetColors()
        {
            ...
            colorBlock.normalColor = SudokuRule.NormalColor;
            colorBlock.disabledColor = SudokuRule.ClueColor;
            colorBlock.selectedColor = SudokuRule.SelectedColor;
            colorBlock.highlightedColor = SudokuRule.HighlightColor;
        ...
        {
            _numberTMP.color = Value == Answer ? SudokuRule.AnswerTextColor : SudokuRule.WrongAnswerTextColor;
        }
